...
class LinkedList:
    ...
    def split(self,index):
        ...
        new_list.first.setNext(cursor.getNext())
        cursor.setNext(None)
        
        new_list.numItems = self.numItems - index 
        self.numItems = index 
    ...
    def merge(self, other):
        ...
        while cursor_self!=None and cursor_other!=None:
            ...
            else: #cursor_other.getItem()<cursor_self.getItem():
...
def main():
    with open("cab.csv","a") as cab:
        for i in range(1,10000):
            ...
            runtime = thread_time()
            lst.merge_sort()
            runtime2 = thread_time()
            print(i)
            cab.write("{},{}\n".format(i,runtime2-runtime))
